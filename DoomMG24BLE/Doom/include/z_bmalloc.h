...
#define IMPLEMENT_BLOCK_MEMORY_ALLOC_ZONE(name, objectSize, tag, num, desc) struct block_memory_alloc_s name = { .firstpool_sptr = 0, .size = objectSize, .perpool = num}
#define NULL_BLOCK_MEMORY_ALLOC_ZONE(name) name.firstpool_sptr =0

DECLARE_BLOCK_MEMORY_ALLOC_ZONE(mobjzone);
DECLARE_BLOCK_MEMORY_ALLOC_ZONE(static_mobjzone);
DECLARE_BLOCK_MEMORY_ALLOC_ZONE(dropped_mobj_xy_zone);
