...
typedef struct
{
    ...
    short width, height;
// 2022/02/01 next-hack: we are no more supporting multi patch textures: the wad converter takes care of multi patch textures.
...
// 2022/02/01 next-hack: now getTextureStructSize() is just a constant value.
#define getTextureStructSize(t) (sizeof(texture_t))
