...
// next-hack: Remove*ThinkerDelayed receive also pointer to prev thinker, for removal.
void P_RemoveThinkerDelayed(thinker_t *thinker, thinker_t * prev_thinker);    // killough 4/25/98
void P_RemoveStaticThinkerDelayed(thinker_t *thinker, thinker_t * prev_thinker); // 2021-03-13 next-hack
