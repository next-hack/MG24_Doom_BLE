...
typedef struct
{
// 30-01-2022 next-hack: optimzed out some bytes... 
    uint8_t sprite; /* sprite number to show                       */
    uint8_t frame; /* which frame/subframe of the sprite is shown */
    ...
    int8_t misc1, misc2; /* apparently never used in DOOM               */
...
#define MOBJ_TYPE_CORPSE  0x4000
#define MOBJ_TYPE_DROPPED 0x8000
/********************************************************************
