 ...
 *  This saves up many tens bytes/mobj.
 *-----------------------------------------------------------------------------
 */
...
// as SPR_xxxx
typedef char checkMobjType[((NUMMOBJTYPES - 1) &  (MOBJ_TYPE_CORPSE  | MOBJ_TYPE_DROPPED) ) ? -1 : 0];   // will give an error if MOBJ_TYPE_CORPSE has bad mask.
...
#define CF(f) ( (f & 32768) ? ((f & ~32768) & 0xFF) | FF_FULLBRIGHT : f)
const state_t states[NUMSTATES] =
{
    ...
    { SPR_PISF, CF(32768), 7, A_Light1, S_LIGHTDONE, 0, 0 },  // S_PISTOLFLASH
    ...
    { SPR_SHTF, CF(32768), 4, A_Light1, S_SGUNFLASH2, 0, 0 }, // S_SGUNFLASH1
    { SPR_SHTF, CF(32769), 3, A_Light2, S_LIGHTDONE, 0, 0 },  // S_SGUNFLASH2
    ...
    { SPR_SHT2, CF(32776), 5, A_Light1, S_DSGUNFLASH2, 0, 0 },  // S_DSGUNFLASH1
    { SPR_SHT2, CF(32777), 4, A_Light2, S_LIGHTDONE, 0, 0 },  // S_DSGUNFLASH2
    ...
    { SPR_CHGF, CF(32768), 5, A_Light1, S_LIGHTDONE, 0, 0 },  // S_CHAINFLASH1
    { SPR_CHGF, CF(32769), 5, A_Light2, S_LIGHTDONE, 0, 0 },  // S_CHAINFLASH2
    ...
    { SPR_MISF, CF(32768), 3, A_Light1, S_MISSILEFLASH2, 0, 0 },  // S_MISSILEFLASH1
    { SPR_MISF, CF(32769), 4, NULL, S_MISSILEFLASH3, 0, 0 },  // S_MISSILEFLASH2
    { SPR_MISF, CF(32770), 4, A_Light2, S_MISSILEFLASH4, 0, 0 },  // S_MISSILEFLASH3
    { SPR_MISF, CF(32771), 4, A_Light2, S_LIGHTDONE, 0, 0 },  // S_MISSILEFLASH4
    ...
    { SPR_PLSF, CF(32768), 4, A_Light1, S_LIGHTDONE, 0, 0 },  // S_PLASMAFLASH1
    { SPR_PLSF, CF(32769), 4, A_Light1, S_LIGHTDONE, 0, 0 },  // S_PLASMAFLASH2
    ...
    { SPR_BFGF, CF(32768), 11, A_Light1, S_BFGFLASH2, 0, 0 }, // S_BFGFLASH1
    { SPR_BFGF, CF(32769), 6, A_Light2, S_LIGHTDONE, 0, 0 },  // S_BFGFLASH2
    { SPR_BLUD, 2, 8, NULL, S_BLOOD2, 0, 0 }, // S_BLOOD1
    { SPR_BLUD, 1, 8, NULL, S_BLOOD3, 0, 0 }, // S_BLOOD2
    { SPR_BLUD, 0, 8, NULL, S_NULL, 0, 0 }, // S_BLOOD3
    { SPR_PUFF, CF(32768), 4, NULL, S_PUFF2, 0, 0 },  // S_PUFF1
    { SPR_PUFF, 1, 4, NULL, S_PUFF3, 0, 0 },  // S_PUFF2
    { SPR_PUFF, 2, 4, NULL, S_PUFF4, 0, 0 },  // S_PUFF3
    { SPR_PUFF, 3, 4, NULL, S_NULL, 0, 0 }, // S_PUFF4
    { SPR_BAL1, CF(32768), 4, NULL, S_TBALL2, 0, 0 }, // S_TBALL1
    { SPR_BAL1, CF(32769), 4, NULL, S_TBALL1, 0, 0 }, // S_TBALL2
    { SPR_BAL1, CF(32770), 6, NULL, S_TBALLX2, 0, 0 },  // S_TBALLX1
    { SPR_BAL1, CF(32771), 6, NULL, S_TBALLX3, 0, 0 },  // S_TBALLX2
    { SPR_BAL1, CF(32772), 6, NULL, S_NULL, 0, 0 }, // S_TBALLX3
    { SPR_BAL2, CF(32768), 4, NULL, S_RBALL2, 0, 0 }, // S_RBALL1
    { SPR_BAL2, CF(32769), 4, NULL, S_RBALL1, 0, 0 }, // S_RBALL2
    { SPR_BAL2, CF(32770), 6, NULL, S_RBALLX2, 0, 0 },  // S_RBALLX1
    { SPR_BAL2, CF(32771), 6, NULL, S_RBALLX3, 0, 0 },  // S_RBALLX2
    { SPR_BAL2, CF(32772), 6, NULL, S_NULL, 0, 0 }, // S_RBALLX3
    { SPR_PLSS, CF(32768), 6, NULL, S_PLASBALL2, 0, 0 },  // S_PLASBALL
    { SPR_PLSS, CF(32769), 6, NULL, S_PLASBALL, 0, 0 }, // S_PLASBALL2
    { SPR_PLSE, CF(32768), 4, NULL, S_PLASEXP2, 0, 0 }, // S_PLASEXP
    { SPR_PLSE, CF(32769), 4, NULL, S_PLASEXP3, 0, 0 }, // S_PLASEXP2
    { SPR_PLSE, CF(32770), 4, NULL, S_PLASEXP4, 0, 0 }, // S_PLASEXP3
    { SPR_PLSE, CF(32771), 4, NULL, S_PLASEXP5, 0, 0 }, // S_PLASEXP4
    { SPR_PLSE, CF(32772), 4, NULL, S_NULL, 0, 0 }, // S_PLASEXP5
    { SPR_MISL, CF(32768), 1, NULL, S_ROCKET, 0, 0 }, // S_ROCKET
    { SPR_BFS1, CF(32768), 4, NULL, S_BFGSHOT2, 0, 0 }, // S_BFGSHOT
    { SPR_BFS1, CF(32769), 4, NULL, S_BFGSHOT, 0, 0 },  // S_BFGSHOT2
    { SPR_BFE1, CF(32768), 8, NULL, S_BFGLAND2, 0, 0 }, // S_BFGLAND
    { SPR_BFE1, CF(32769), 8, NULL, S_BFGLAND3, 0, 0 }, // S_BFGLAND2
    { SPR_BFE1, CF(32770), 8, A_BFGSpray, S_BFGLAND4, 0, 0 }, // S_BFGLAND3
    { SPR_BFE1, CF(32771), 8, NULL, S_BFGLAND5, 0, 0 }, // S_BFGLAND4
    { SPR_BFE1, CF(32772), 8, NULL, S_BFGLAND6, 0, 0 }, // S_BFGLAND5
    { SPR_BFE1, CF(32773), 8, NULL, S_NULL, 0, 0 }, // S_BFGLAND6
    { SPR_BFE2, CF(32768), 8, NULL, S_BFGEXP2, 0, 0 },  // S_BFGEXP
    { SPR_BFE2, CF(32769), 8, NULL, S_BFGEXP3, 0, 0 },  // S_BFGEXP2
    { SPR_BFE2, CF(32770), 8, NULL, S_BFGEXP4, 0, 0 },  // S_BFGEXP3
    { SPR_BFE2, CF(32771), 8, NULL, S_NULL, 0, 0 }, // S_BFGEXP4
    { SPR_MISL, CF(32769), 8, A_Explode, S_EXPLODE2, 0, 0 },  // S_EXPLODE1
    { SPR_MISL, CF(32770), 6, NULL, S_EXPLODE3, 0, 0 }, // S_EXPLODE2
    { SPR_MISL, CF(32771), 4, NULL, S_NULL, 0, 0 }, // S_EXPLODE3
    { SPR_TFOG, CF(32768), 6, NULL, S_TFOG01, 0, 0 }, // S_TFOG
    { SPR_TFOG, CF(32769), 6, NULL, S_TFOG02, 0, 0 }, // S_TFOG01
    { SPR_TFOG, CF(32768), 6, NULL, S_TFOG2, 0, 0 },  // S_TFOG02
    { SPR_TFOG, CF(32769), 6, NULL, S_TFOG3, 0, 0 },  // S_TFOG2
    { SPR_TFOG, CF(32770), 6, NULL, S_TFOG4, 0, 0 },  // S_TFOG3
    { SPR_TFOG, CF(32771), 6, NULL, S_TFOG5, 0, 0 },  // S_TFOG4
    { SPR_TFOG, CF(32772), 6, NULL, S_TFOG6, 0, 0 },  // S_TFOG5
    { SPR_TFOG, CF(32773), 6, NULL, S_TFOG7, 0, 0 },  // S_TFOG6
    { SPR_TFOG, CF(32774), 6, NULL, S_TFOG8, 0, 0 },  // S_TFOG7
    { SPR_TFOG, CF(32775), 6, NULL, S_TFOG9, 0, 0 },  // S_TFOG8
    { SPR_TFOG, CF(32776), 6, NULL, S_TFOG10, 0, 0 }, // S_TFOG9
    { SPR_TFOG, CF(32777), 6, NULL, S_NULL, 0, 0 }, // S_TFOG10
    { SPR_IFOG, CF(32768), 6, NULL, S_IFOG01, 0, 0 }, // S_IFOG
    { SPR_IFOG, CF(32769), 6, NULL, S_IFOG02, 0, 0 }, // S_IFOG01
    { SPR_IFOG, CF(32768), 6, NULL, S_IFOG2, 0, 0 },  // S_IFOG02
    { SPR_IFOG, CF(32769), 6, NULL, S_IFOG3, 0, 0 },  // S_IFOG2
    { SPR_IFOG, CF(32770), 6, NULL, S_IFOG4, 0, 0 },  // S_IFOG3
    { SPR_IFOG, CF(32771), 6, NULL, S_IFOG5, 0, 0 },  // S_IFOG4
    { SPR_IFOG, CF(32772), 6, NULL, S_NULL, 0, 0 }, // S_IFOG5
    ...
    { SPR_PLAY, CF(32773), 6, NULL, S_PLAY_ATK1, 0, 0 },  // S_PLAY_ATK2
    ...
    { SPR_SPOS, CF(32773), 10, A_SPosAttack, S_SPOS_ATK3, 0, 0 }, // S_SPOS_ATK2
    ...
    { SPR_VILE, CF(32774), 0, A_VileStart, S_VILE_ATK2, 0, 0 }, // S_VILE_ATK1
    { SPR_VILE, CF(32774), 10, A_FaceTarget, S_VILE_ATK3, 0, 0 }, // S_VILE_ATK2
    { SPR_VILE, CF(32775), 8, A_VileTarget, S_VILE_ATK4, 0, 0 },  // S_VILE_ATK3
    { SPR_VILE, CF(32776), 8, A_FaceTarget, S_VILE_ATK5, 0, 0 },  // S_VILE_ATK4
    { SPR_VILE, CF(32777), 8, A_FaceTarget, S_VILE_ATK6, 0, 0 },  // S_VILE_ATK5
    { SPR_VILE, CF(32778), 8, A_FaceTarget, S_VILE_ATK7, 0, 0 },  // S_VILE_ATK6
    { SPR_VILE, CF(32779), 8, A_FaceTarget, S_VILE_ATK8, 0, 0 },  // S_VILE_ATK7
    { SPR_VILE, CF(32780), 8, A_FaceTarget, S_VILE_ATK9, 0, 0 },  // S_VILE_ATK8
    { SPR_VILE, CF(32781), 8, A_FaceTarget, S_VILE_ATK10, 0, 0 }, // S_VILE_ATK9
    { SPR_VILE, CF(32782), 8, A_VileAttack, S_VILE_ATK11, 0, 0 }, // S_VILE_ATK10
    { SPR_VILE, CF(32783), 20, NULL, S_VILE_RUN1, 0, 0 }, // S_VILE_ATK11
    { SPR_VILE, CF(32794), 10, NULL, S_VILE_HEAL2, 0, 0 },  // S_VILE_HEAL1
    { SPR_VILE, CF(32795), 10, NULL, S_VILE_HEAL3, 0, 0 },  // S_VILE_HEAL2
    { SPR_VILE, CF(32796), 10, NULL, S_VILE_RUN1, 0, 0 }, // S_VILE_HEAL3
    ...
    { SPR_FIRE, CF(32768), 2, A_StartFire, S_FIRE2, 0, 0 }, // S_FIRE1
    { SPR_FIRE, CF(32769), 2, A_Fire, S_FIRE3, 0, 0 },  // S_FIRE2
    { SPR_FIRE, CF(32768), 2, A_Fire, S_FIRE4, 0, 0 },  // S_FIRE3
    { SPR_FIRE, CF(32769), 2, A_Fire, S_FIRE5, 0, 0 },  // S_FIRE4
    { SPR_FIRE, CF(32770), 2, A_FireCrackle, S_FIRE6, 0, 0 }, // S_FIRE5
    { SPR_FIRE, CF(32769), 2, A_Fire, S_FIRE7, 0, 0 },  // S_FIRE6
    { SPR_FIRE, CF(32770), 2, A_Fire, S_FIRE8, 0, 0 },  // S_FIRE7
    { SPR_FIRE, CF(32769), 2, A_Fire, S_FIRE9, 0, 0 },  // S_FIRE8
    { SPR_FIRE, CF(32770), 2, A_Fire, S_FIRE10, 0, 0 }, // S_FIRE9
    { SPR_FIRE, CF(32771), 2, A_Fire, S_FIRE11, 0, 0 }, // S_FIRE10
    { SPR_FIRE, CF(32770), 2, A_Fire, S_FIRE12, 0, 0 }, // S_FIRE11
    { SPR_FIRE, CF(32771), 2, A_Fire, S_FIRE13, 0, 0 }, // S_FIRE12
    { SPR_FIRE, CF(32770), 2, A_Fire, S_FIRE14, 0, 0 }, // S_FIRE13
    { SPR_FIRE, CF(32771), 2, A_Fire, S_FIRE15, 0, 0 }, // S_FIRE14
    { SPR_FIRE, CF(32772), 2, A_Fire, S_FIRE16, 0, 0 }, // S_FIRE15
    { SPR_FIRE, CF(32771), 2, A_Fire, S_FIRE17, 0, 0 }, // S_FIRE16
    { SPR_FIRE, CF(32772), 2, A_Fire, S_FIRE18, 0, 0 }, // S_FIRE17
    { SPR_FIRE, CF(32771), 2, A_Fire, S_FIRE19, 0, 0 }, // S_FIRE18
    { SPR_FIRE, CF(32772), 2, A_FireCrackle, S_FIRE20, 0, 0 },  // S_FIRE19
    { SPR_FIRE, CF(32773), 2, A_Fire, S_FIRE21, 0, 0 }, // S_FIRE20
    { SPR_FIRE, CF(32772), 2, A_Fire, S_FIRE22, 0, 0 }, // S_FIRE21
    { SPR_FIRE, CF(32773), 2, A_Fire, S_FIRE23, 0, 0 }, // S_FIRE22
    { SPR_FIRE, CF(32772), 2, A_Fire, S_FIRE24, 0, 0 }, // S_FIRE23
    { SPR_FIRE, CF(32773), 2, A_Fire, S_FIRE25, 0, 0 }, // S_FIRE24
    { SPR_FIRE, CF(32774), 2, A_Fire, S_FIRE26, 0, 0 }, // S_FIRE25
    { SPR_FIRE, CF(32775), 2, A_Fire, S_FIRE27, 0, 0 }, // S_FIRE26
    { SPR_FIRE, CF(32774), 2, A_Fire, S_FIRE28, 0, 0 }, // S_FIRE27
    { SPR_FIRE, CF(32775), 2, A_Fire, S_FIRE29, 0, 0 }, // S_FIRE28
    { SPR_FIRE, CF(32774), 2, A_Fire, S_FIRE30, 0, 0 }, // S_FIRE29
    { SPR_FIRE, CF(32775), 2, A_Fire, S_NULL, 0, 0 }, // S_FIRE30
    ...
    { SPR_FATB, CF(32768), 2, A_Tracer, S_TRACER2, 0, 0 },  // S_TRACER
    { SPR_FATB, CF(32769), 2, A_Tracer, S_TRACER, 0, 0 }, // S_TRACER2
    { SPR_FBXP, CF(32768), 8, NULL, S_TRACEEXP2, 0, 0 },  // S_TRACEEXP1
    { SPR_FBXP, CF(32769), 6, NULL, S_TRACEEXP3, 0, 0 },  // S_TRACEEXP2
    { SPR_FBXP, CF(32770), 4, NULL, S_NULL, 0, 0 }, // S_TRACEEXP3
    ...
    { SPR_SKEL, CF(32777), 0, A_FaceTarget, S_SKEL_MISS2, 0, 0 }, // S_SKEL_MISS1
    { SPR_SKEL, CF(32777), 10, A_FaceTarget, S_SKEL_MISS3, 0, 0 },  // S_SKEL_MISS2
    ...
    { SPR_MANF, CF(32768), 4, NULL, S_FATSHOT2, 0, 0 }, // S_FATSHOT1
    { SPR_MANF, CF(32769), 4, NULL, S_FATSHOT1, 0, 0 }, // S_FATSHOT2
    { SPR_MISL, CF(32769), 8, NULL, S_FATSHOTX2, 0, 0 },  // S_FATSHOTX1
    { SPR_MISL, CF(32770), 6, NULL, S_FATSHOTX3, 0, 0 },  // S_FATSHOTX2
    { SPR_MISL, CF(32771), 4, NULL, S_NULL, 0, 0 }, // S_FATSHOTX3
    ...
    { SPR_CPOS, CF(32773), 4, A_CPosAttack, S_CPOS_ATK3, 0, 0 },  // S_CPOS_ATK2
    { SPR_CPOS, CF(32772), 4, A_CPosAttack, S_CPOS_ATK4, 0, 0 },  // S_CPOS_ATK3
    ...
    { SPR_HEAD, CF(32771), 5, A_HeadAttack, S_HEAD_RUN1, 0, 0 },  // S_HEAD_ATK3
    ...
    { SPR_BAL7, CF(32768), 4, NULL, S_BRBALL2, 0, 0 },  // S_BRBALL1
    { SPR_BAL7, CF(32769), 4, NULL, S_BRBALL1, 0, 0 },  // S_BRBALL2
    { SPR_BAL7, CF(32770), 6, NULL, S_BRBALLX2, 0, 0 }, // S_BRBALLX1
    { SPR_BAL7, CF(32771), 6, NULL, S_BRBALLX3, 0, 0 }, // S_BRBALLX2
    { SPR_BAL7, CF(32772), 6, NULL, S_NULL, 0, 0 }, // S_BRBALLX3
    ...
    { SPR_SKUL, CF(32768), 10, A_Look, S_SKULL_STND2, 0, 0 }, // S_SKULL_STND
    { SPR_SKUL, CF(32769), 10, A_Look, S_SKULL_STND, 0, 0 },  // S_SKULL_STND2
    { SPR_SKUL, CF(32768), 6, A_Chase, S_SKULL_RUN2, 0, 0 },  // S_SKULL_RUN1
    { SPR_SKUL, CF(32769), 6, A_Chase, S_SKULL_RUN1, 0, 0 },  // S_SKULL_RUN2
    { SPR_SKUL, CF(32770), 10, A_FaceTarget, S_SKULL_ATK2, 0, 0 },  // S_SKULL_ATK1
    { SPR_SKUL, CF(32771), 4, A_SkullAttack, S_SKULL_ATK3, 0, 0 },  // S_SKULL_ATK2
    { SPR_SKUL, CF(32770), 4, NULL, S_SKULL_ATK4, 0, 0 }, // S_SKULL_ATK3
    { SPR_SKUL, CF(32771), 4, NULL, S_SKULL_ATK3, 0, 0 }, // S_SKULL_ATK4
    { SPR_SKUL, CF(32772), 3, NULL, S_SKULL_PAIN2, 0, 0 },  // S_SKULL_PAIN
    { SPR_SKUL, CF(32772), 3, A_Pain, S_SKULL_RUN1, 0, 0 }, // S_SKULL_PAIN2
    { SPR_SKUL, CF(32773), 6, NULL, S_SKULL_DIE2, 0, 0 }, // S_SKULL_DIE1
    { SPR_SKUL, CF(32774), 6, A_Scream, S_SKULL_DIE3, 0, 0 }, // S_SKULL_DIE2
    { SPR_SKUL, CF(32775), 6, NULL, S_SKULL_DIE4, 0, 0 }, // S_SKULL_DIE3
    { SPR_SKUL, CF(32776), 6, A_Fall, S_SKULL_DIE5, 0, 0 }, // S_SKULL_DIE4
    ...
    { SPR_SPID, CF(32768), 20, A_FaceTarget, S_SPID_ATK2, 0, 0 }, // S_SPID_ATK1
    { SPR_SPID, CF(32774), 4, A_SPosAttack, S_SPID_ATK3, 0, 0 },  // S_SPID_ATK2
    { SPR_SPID, CF(32775), 4, A_SPosAttack, S_SPID_ATK4, 0, 0 },  // S_SPID_ATK3
    { SPR_SPID, CF(32775), 1, A_SpidRefire, S_SPID_ATK2, 0, 0 },  // S_SPID_ATK4
    ...
    { SPR_BSPI, CF(32768), 20, A_FaceTarget, S_BSPI_ATK2, 0, 0 }, // S_BSPI_ATK1
    { SPR_BSPI, CF(32774), 4, A_BspiAttack, S_BSPI_ATK3, 0, 0 },  // S_BSPI_ATK2
    { SPR_BSPI, CF(32775), 4, NULL, S_BSPI_ATK4, 0, 0 },  // S_BSPI_ATK3
    { SPR_BSPI, CF(32775), 1, A_SpidRefire, S_BSPI_ATK2, 0, 0 },  // S_BSPI_ATK4
    ...
    { SPR_APLS, CF(32768), 5, NULL, S_ARACH_PLAZ2, 0, 0 },  // S_ARACH_PLAZ
    { SPR_APLS, CF(32769), 5, NULL, S_ARACH_PLAZ, 0, 0 }, // S_ARACH_PLAZ2
    { SPR_APBX, CF(32768), 5, NULL, S_ARACH_PLEX2, 0, 0 },  // S_ARACH_PLEX
    { SPR_APBX, CF(32769), 5, NULL, S_ARACH_PLEX3, 0, 0 },  // S_ARACH_PLEX2
    { SPR_APBX, CF(32770), 5, NULL, S_ARACH_PLEX4, 0, 0 },  // S_ARACH_PLEX3
    { SPR_APBX, CF(32771), 5, NULL, S_ARACH_PLEX5, 0, 0 },  // S_ARACH_PLEX4
    { SPR_APBX, CF(32772), 5, NULL, S_NULL, 0, 0 }, // S_ARACH_PLEX5
    ...
    { SPR_PAIN, CF(32773), 5, A_FaceTarget, S_PAIN_ATK4, 0, 0 },  // S_PAIN_ATK3
    { SPR_PAIN, CF(32773), 0, A_PainAttack, S_PAIN_RUN1, 0, 0 },  // S_PAIN_ATK4
    { SPR_PAIN, 6, 6, NULL, S_PAIN_PAIN2, 0, 0 }, // S_PAIN_PAIN
    { SPR_PAIN, 6, 6, A_Pain, S_PAIN_RUN1, 0, 0 },  // S_PAIN_PAIN2
    { SPR_PAIN, CF(32775), 8, NULL, S_PAIN_DIE2, 0, 0 },  // S_PAIN_DIE1
    { SPR_PAIN, CF(32776), 8, A_Scream, S_PAIN_DIE3, 0, 0 },  // S_PAIN_DIE2
    { SPR_PAIN, CF(32777), 8, NULL, S_PAIN_DIE4, 0, 0 },  // S_PAIN_DIE3
    { SPR_PAIN, CF(32778), 8, NULL, S_PAIN_DIE5, 0, 0 },  // S_PAIN_DIE4
    { SPR_PAIN, CF(32779), 8, A_PainDie, S_PAIN_DIE6, 0, 0 }, // S_PAIN_DIE5
    { SPR_PAIN, CF(32780), 8, NULL, S_NULL, 0, 0 }, // S_PAIN_DIE6
    ...
    { SPR_SSWV, CF(32774), 4, A_CPosAttack, S_SSWV_ATK4, 0, 0 },  // S_SSWV_ATK3
    { SPR_SSWV, 5, 6, A_FaceTarget, S_SSWV_ATK5, 0, 0 },  // S_SSWV_ATK4
    { SPR_SSWV, CF(32774), 4, A_CPosAttack, S_SSWV_ATK6, 0, 0 },  // S_SSWV_ATK5
    ...
    { SPR_BOSF, CF(32768), 3, A_SpawnSound, S_SPAWN2, 0, 0 }, // S_SPAWN1
    { SPR_BOSF, CF(32769), 3, A_SpawnFly, S_SPAWN3, 0, 0 }, // S_SPAWN2
    { SPR_BOSF, CF(32770), 3, A_SpawnFly, S_SPAWN4, 0, 0 }, // S_SPAWN3
    { SPR_BOSF, CF(32771), 3, A_SpawnFly, S_SPAWN1, 0, 0 }, // S_SPAWN4
    { SPR_FIRE, CF(32768), 4, A_Fire, S_SPAWNFIRE2, 0, 0 }, // S_SPAWNFIRE1
    { SPR_FIRE, CF(32769), 4, A_Fire, S_SPAWNFIRE3, 0, 0 }, // S_SPAWNFIRE2
    { SPR_FIRE, CF(32770), 4, A_Fire, S_SPAWNFIRE4, 0, 0 }, // S_SPAWNFIRE3
    { SPR_FIRE, CF(32771), 4, A_Fire, S_SPAWNFIRE5, 0, 0 }, // S_SPAWNFIRE4
    { SPR_FIRE, CF(32772), 4, A_Fire, S_SPAWNFIRE6, 0, 0 }, // S_SPAWNFIRE5
    { SPR_FIRE, CF(32773), 4, A_Fire, S_SPAWNFIRE7, 0, 0 }, // S_SPAWNFIRE6
    { SPR_FIRE, CF(32774), 4, A_Fire, S_SPAWNFIRE8, 0, 0 }, // S_SPAWNFIRE7
    { SPR_FIRE, CF(32775), 4, A_Fire, S_NULL, 0, 0 },   // S_SPAWNFIRE8
    { SPR_MISL, CF(32769), 10, NULL, S_BRAINEXPLODE2, 0, 0 }, // S_BRAINEXPLODE1
    { SPR_MISL, CF(32770), 10, NULL, S_BRAINEXPLODE3, 0, 0 }, // S_BRAINEXPLODE2
    { SPR_MISL, CF(32771), 10, A_BrainExplode, S_NULL, 0, 0 },  // S_BRAINEXPLODE3
    { SPR_ARM1, 0, 6, NULL, S_ARM1A, 0, 0 },  // S_ARM1
    { SPR_ARM1, CF(32769), 7, NULL, S_ARM1, 0, 0 }, // S_ARM1A
    { SPR_ARM2, 0, 6, NULL, S_ARM2A, 0, 0 },  // S_ARM2
    { SPR_ARM2, CF(32769), 6, NULL, S_ARM2, 0, 0 }, // S_ARM2A
    { SPR_BAR1, 0, 6, NULL, S_BAR2, 0, 0 }, // S_BAR1
    { SPR_BAR1, 1, 6, NULL, S_BAR1, 0, 0 }, // S_BAR2
    { SPR_BEXP, CF(32768), 5, NULL, S_BEXP2, 0, 0 },  // S_BEXP
    { SPR_BEXP, CF(32769), 5, A_Scream, S_BEXP3, 0, 0 },  // S_BEXP2
    { SPR_BEXP, CF(32770), 5, NULL, S_BEXP4, 0, 0 },  // S_BEXP3
    { SPR_BEXP, CF(32771), 10, A_Explode, S_BEXP5, 0, 0 },  // S_BEXP4
    { SPR_BEXP, CF(32772), 10, NULL, S_NULL, 0, 0 },  // S_BEXP5
    { SPR_FCAN, CF(32768), 4, NULL, S_BBAR2, 0, 0 },  // S_BBAR1
    { SPR_FCAN, CF(32769), 4, NULL, S_BBAR3, 0, 0 },  // S_BBAR2
    { SPR_FCAN, CF(32770), 4, NULL, S_BBAR1, 0, 0 },  // S_BBAR3
    ...
    { SPR_BKEY, CF(32769), 10, NULL, S_BKEY, 0, 0 },  // S_BKEY2
    { SPR_RKEY, 0, 10, NULL, S_RKEY2, 0, 0 }, // S_RKEY
    { SPR_RKEY, CF(32769), 10, NULL, S_RKEY, 0, 0 },  // S_RKEY2
    { SPR_YKEY, 0, 10, NULL, S_YKEY2, 0, 0 }, // S_YKEY
    { SPR_YKEY, CF(32769), 10, NULL, S_YKEY, 0, 0 },  // S_YKEY2
    { SPR_BSKU, 0, 10, NULL, S_BSKULL2, 0, 0 }, // S_BSKULL
    { SPR_BSKU, CF(32769), 10, NULL, S_BSKULL, 0, 0 },  // S_BSKULL2
    { SPR_RSKU, 0, 10, NULL, S_RSKULL2, 0, 0 }, // S_RSKULL
    { SPR_RSKU, CF(32769), 10, NULL, S_RSKULL, 0, 0 },  // S_RSKULL2
    { SPR_YSKU, 0, 10, NULL, S_YSKULL2, 0, 0 }, // S_YSKULL
    { SPR_YSKU, CF(32769), 10, NULL, S_YSKULL, 0, 0 },  // S_YSKULL2
    { SPR_STIM, 0, -1, NULL, S_NULL, 0, 0 },  // S_STIM
    { SPR_MEDI, 0, -1, NULL, S_NULL, 0, 0 },  // S_MEDI
    { SPR_SOUL, CF(32768), 6, NULL, S_SOUL2, 0, 0 },  // S_SOUL
    { SPR_SOUL, CF(32769), 6, NULL, S_SOUL3, 0, 0 },  // S_SOUL2
    { SPR_SOUL, CF(32770), 6, NULL, S_SOUL4, 0, 0 },  // S_SOUL3
    { SPR_SOUL, CF(32771), 6, NULL, S_SOUL5, 0, 0 },  // S_SOUL4
    { SPR_SOUL, CF(32770), 6, NULL, S_SOUL6, 0, 0 },  // S_SOUL5
    { SPR_SOUL, CF(32769), 6, NULL, S_SOUL, 0, 0 }, // S_SOUL6
    { SPR_PINV, CF(32768), 6, NULL, S_PINV2, 0, 0 },  // S_PINV
    { SPR_PINV, CF(32769), 6, NULL, S_PINV3, 0, 0 },  // S_PINV2
    { SPR_PINV, CF(32770), 6, NULL, S_PINV4, 0, 0 },  // S_PINV3
    { SPR_PINV, CF(32771), 6, NULL, S_PINV, 0, 0 }, // S_PINV4
    { SPR_PSTR, CF(32768), -1, NULL, S_NULL, 0, 0 },  // S_PSTR
    { SPR_PINS, CF(32768), 6, NULL, S_PINS2, 0, 0 },  // S_PINS
    { SPR_PINS, CF(32769), 6, NULL, S_PINS3, 0, 0 },  // S_PINS2
    { SPR_PINS, CF(32770), 6, NULL, S_PINS4, 0, 0 },  // S_PINS3
    { SPR_PINS, CF(32771), 6, NULL, S_PINS, 0, 0 }, // S_PINS4
    { SPR_MEGA, CF(32768), 6, NULL, S_MEGA2, 0, 0 },  // S_MEGA
    { SPR_MEGA, CF(32769), 6, NULL, S_MEGA3, 0, 0 },  // S_MEGA2
    { SPR_MEGA, CF(32770), 6, NULL, S_MEGA4, 0, 0 },  // S_MEGA3
    { SPR_MEGA, CF(32771), 6, NULL, S_MEGA, 0, 0 }, // S_MEGA4
    { SPR_SUIT, CF(32768), -1, NULL, S_NULL, 0, 0 },  // S_SUIT
    { SPR_PMAP, CF(32768), 6, NULL, S_PMAP2, 0, 0 },  // S_PMAP
    { SPR_PMAP, CF(32769), 6, NULL, S_PMAP3, 0, 0 },  // S_PMAP2
    { SPR_PMAP, CF(32770), 6, NULL, S_PMAP4, 0, 0 },  // S_PMAP3
    { SPR_PMAP, CF(32771), 6, NULL, S_PMAP5, 0, 0 },  // S_PMAP4
    { SPR_PMAP, CF(32770), 6, NULL, S_PMAP6, 0, 0 },  // S_PMAP5
    { SPR_PMAP, CF(32769), 6, NULL, S_PMAP, 0, 0 }, // S_PMAP6
    { SPR_PVIS, CF(32768), 6, NULL, S_PVIS2, 0, 0 },  // S_PVIS
    ...
    { SPR_COLU, CF(32768), -1, NULL, S_NULL, 0, 0 },  // S_COLU
    ...
    { SPR_POL3, CF(32768), 6, NULL, S_HEADCANDLES2, 0, 0 }, // S_HEADCANDLES
    { SPR_POL3, CF(32769), 6, NULL, S_HEADCANDLES, 0, 0 },  // S_HEADCANDLES2
    ...
    { SPR_CAND, CF(32768), -1, NULL, S_NULL, 0, 0 },  // S_CANDLESTIK
    { SPR_CBRA, CF(32768), -1, NULL, S_NULL, 0, 0 },  // S_CANDELABRA
    ...
    { SPR_CEYE, CF(32768), 6, NULL, S_EVILEYE2, 0, 0 }, // S_EVILEYE
    { SPR_CEYE, CF(32769), 6, NULL, S_EVILEYE3, 0, 0 }, // S_EVILEYE2
    { SPR_CEYE, CF(32770), 6, NULL, S_EVILEYE4, 0, 0 }, // S_EVILEYE3
    { SPR_CEYE, CF(32769), 6, NULL, S_EVILEYE, 0, 0 },  // S_EVILEYE4
    { SPR_FSKU, CF(32768), 6, NULL, S_FLOATSKULL2, 0, 0 },  // S_FLOATSKULL
    { SPR_FSKU, CF(32769), 6, NULL, S_FLOATSKULL3, 0, 0 },  // S_FLOATSKULL2
    { SPR_FSKU, CF(32770), 6, NULL, S_FLOATSKULL, 0, 0 }, // S_FLOATSKULL3
    { SPR_COL5, 0, 14, NULL, S_HEARTCOL2, 0, 0 }, // S_HEARTCOL
    { SPR_COL5, 1, 14, NULL, S_HEARTCOL, 0, 0 },  // S_HEARTCOL2
    { SPR_TBLU, CF(32768), 4, NULL, S_BLUETORCH2, 0, 0 }, // S_BLUETORCH
    { SPR_TBLU, CF(32769), 4, NULL, S_BLUETORCH3, 0, 0 }, // S_BLUETORCH2
    { SPR_TBLU, CF(32770), 4, NULL, S_BLUETORCH4, 0, 0 }, // S_BLUETORCH3
    { SPR_TBLU, CF(32771), 4, NULL, S_BLUETORCH, 0, 0 },  // S_BLUETORCH4
    { SPR_TGRN, CF(32768), 4, NULL, S_GREENTORCH2, 0, 0 },  // S_GREENTORCH
    { SPR_TGRN, CF(32769), 4, NULL, S_GREENTORCH3, 0, 0 },  // S_GREENTORCH2
    { SPR_TGRN, CF(32770), 4, NULL, S_GREENTORCH4, 0, 0 },  // S_GREENTORCH3
    { SPR_TGRN, CF(32771), 4, NULL, S_GREENTORCH, 0, 0 }, // S_GREENTORCH4
    { SPR_TRED, CF(32768), 4, NULL, S_REDTORCH2, 0, 0 },  // S_REDTORCH
    { SPR_TRED, CF(32769), 4, NULL, S_REDTORCH3, 0, 0 },  // S_REDTORCH2
    { SPR_TRED, CF(32770), 4, NULL, S_REDTORCH4, 0, 0 },  // S_REDTORCH3
    { SPR_TRED, CF(32771), 4, NULL, S_REDTORCH, 0, 0 }, // S_REDTORCH4
    { SPR_SMBT, CF(32768), 4, NULL, S_BTORCHSHRT2, 0, 0 },  // S_BTORCHSHRT
    { SPR_SMBT, CF(32769), 4, NULL, S_BTORCHSHRT3, 0, 0 },  // S_BTORCHSHRT2
    { SPR_SMBT, CF(32770), 4, NULL, S_BTORCHSHRT4, 0, 0 },  // S_BTORCHSHRT3
    { SPR_SMBT, CF(32771), 4, NULL, S_BTORCHSHRT, 0, 0 }, // S_BTORCHSHRT4
    { SPR_SMGT, CF(32768), 4, NULL, S_GTORCHSHRT2, 0, 0 },  // S_GTORCHSHRT
    { SPR_SMGT, CF(32769), 4, NULL, S_GTORCHSHRT3, 0, 0 },  // S_GTORCHSHRT2
    { SPR_SMGT, CF(32770), 4, NULL, S_GTORCHSHRT4, 0, 0 },  // S_GTORCHSHRT3
    { SPR_SMGT, CF(32771), 4, NULL, S_GTORCHSHRT, 0, 0 }, // S_GTORCHSHRT4
    { SPR_SMRT, CF(32768), 4, NULL, S_RTORCHSHRT2, 0, 0 },  // S_RTORCHSHRT
    { SPR_SMRT, CF(32769), 4, NULL, S_RTORCHSHRT3, 0, 0 },  // S_RTORCHSHRT2
    { SPR_SMRT, CF(32770), 4, NULL, S_RTORCHSHRT4, 0, 0 },  // S_RTORCHSHRT3
    { SPR_SMRT, CF(32771), 4, NULL, S_RTORCHSHRT, 0, 0 }, // S_RTORCHSHRT4
    ...
    { SPR_TLMP, CF(32768), 4, NULL, S_TECHLAMP2, 0, 0 },  // S_TECHLAMP
    { SPR_TLMP, CF(32769), 4, NULL, S_TECHLAMP3, 0, 0 },  // S_TECHLAMP2
    { SPR_TLMP, CF(32770), 4, NULL, S_TECHLAMP4, 0, 0 },  // S_TECHLAMP3
    { SPR_TLMP, CF(32771), 4, NULL, S_TECHLAMP, 0, 0 },   // S_TECHLAMP4
    { SPR_TLP2, CF(32768), 4, NULL, S_TECH2LAMP2, 0, 0 }, // S_TECH2LAMP
    { SPR_TLP2, CF(32769), 4, NULL, S_TECH2LAMP3, 0, 0 }, // S_TECH2LAMP2
    { SPR_TLP2, CF(32770), 4, NULL, S_TECH2LAMP4, 0, 0 }, // S_TECH2LAMP3
    { SPR_TLP2, CF(32771), 4, NULL, S_TECH2LAMP, 0, 0 },  // S_TECH2LAMP4
    { SPR_TNT1, 0, -1, NULL, S_TNT1, 0, 0 },          // S_TNT1    // phares 3/8/98

    // killough 8/9/98: grenade
    { SPR_MISL, CF(32768), 1000, A_Die, S_GRENADE },      // S_GRENADE

    // killough 8/10/98: variable damage explosion
    { SPR_MISL, CF(32769), 4, A_Scream, S_DETONATE2 },    // S_DETONATE
    { SPR_MISL, CF(32770), 6, A_Detonate, S_DETONATE3 },  // S_DETONATE2
    { SPR_MISL, CF(32771), 10, NULL, S_NULL },            // S_DETONATE3
    ...
    { SPR_MISL, CF(32769), 8, A_Mushroom, S_EXPLODE2 },  // S_MUSHROOM
};
